...
{
    [CreateAssetMenu(fileName = "TestDeviceConfigDataSO", menuName = "AdsFramework/TestDeviceConfigData")]
    public class TestDeviceConfigData : ScriptableObject
    {
        public const string TEST_DEVICE_ID_DATA_CONST = "AdsFramework/TestDeviceConfigDataSO";
